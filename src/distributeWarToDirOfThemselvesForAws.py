...
def clean():
    t = 0
    for j in getAllDir(r'C:\Users\vivis\Desktop\desktop_Store\newboss-deploy\deploy-mount\boss-services'):
        cleanDir(j)
        t += 1
        print t
...
def copyAll():
    fromPathRoot = r'C:\Users\vivis\Desktop\desktop_Store\newboss-deploy\package'
    ...
    t = 0
    for i in warNameList:
        topath = os.path.join(r'C:\Users\vivis\Desktop\desktop_Store\newboss-deploy\deploy-mount\boss-services', i)
